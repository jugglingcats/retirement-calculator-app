...
import { AssetBalances, AssetDrawdownResult, TaxSettings } from "@/lib/types"
...
export function performTaxOptimizedDrawdown(
    ...
    return new TaxOptimizedStrategy(
        ...
        growthRates
    ).withdrawFromAssets(assets, amount, currentTaxableIncome)
}
...
describe("performTaxOptimizedDrawdown", () => {
